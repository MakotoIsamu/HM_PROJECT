    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-xl w-96">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black focus:border-indigo-500"
              required
            />
          </div>
          <div>
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <button onClick={onSwitchToLogin} className="font-medium text-black hover:text-gray-800">
            Login here
          </button>
        </p>
      </div>
